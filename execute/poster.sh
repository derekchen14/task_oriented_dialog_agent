python 3_advanced.py --task-name challenge --model-type gru \
    --optimizer Adam --save-model --early-stopping 2.8 --weight-decay 0.01 \
...
python 3_advanced.py --task-name challenge --model-type gru \
    --optimizer SGD --save-model --early-stopping 2.8 --weight-decay 0.01 \
