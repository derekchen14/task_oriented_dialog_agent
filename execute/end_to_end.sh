CUDA_VISIBLE_DEVICES=0  python run.py --gpu=0 --task end_to_end -e 40 \
    ...
    --pool-size 5000 --prefix apr25_ --suffix _14 --verbose

CUDA_VISIBLE_DEVICES=1  python run.py --gpu=1 --task end_to_end -e 40 \
    --epsilon 0.0 --hidden-dim 100 --embedding-size 200 \
    --batch-size 16 --seed 15 --warm-start --model ddq --max-turn 40 \
    --user simulate --metrics success_rate avg_reward --dataset e2e/movies \
    --learning-rate 1e-3 --optimizer rmsprop --weight-decay 0.0 \
    --pool-size 5000 --prefix apr25_ --suffix _15 --verbose
