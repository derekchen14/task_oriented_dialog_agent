...
# python 4_attention.py -t schedule --hidden-size 256 --n-layers 1 --drop-prob 0.3 -enp 'results/sch1_wd_en.pt' -edp 'results/sch1_wd_de.pt' -ep 'results/sch1_wd_error.csv' -s -teach 0.60
