...
python 4_attention.py -t challenge --hidden-size 256 --n-layers 1 --drop-prob 0.3 -enp 'results/bid_best_en.pt' -edp 'results/bid_best_de.pt' -ep 'results/bid_best_error.csv' -s -teach 0.60
