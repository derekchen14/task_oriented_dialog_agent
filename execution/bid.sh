...
python 4_attention.py -t challenge --hidden-size 512 --n-layers 1 --drop-prob 0.3 -enp 'results/bid_best.pt' -edp 'results/bid_best.pt' -ep 'results/bidre3_error.csv' -teach 0.60
